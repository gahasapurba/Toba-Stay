...
@else
<div class="container-fluid kontrakan-header position-relative">
    <div class="container pt-5 mt-5">
        <h3 class="text-white pt-5">Pilihan kontrakan untuk anda</h3>
        <div class="col mt-4">
...
<div class="container pt-5 mt-4">
    <div class="row ms-5">
        ...
        <div class="col col-md-4">
            <a href="{{ ('/kontrakan/detail') }}/{{ ($list->id_akomodasi) }}">
                <div class="project">
