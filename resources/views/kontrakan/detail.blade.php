        ...
        <div class="container  shadow jejak">
            <div class="p-jejak ps-2">
                <p>
                    ...
                    <a href="/kontrakan/detail/{{ $detail->id_akomodasi }}">{{ $detail->nama_akomodasi }}</a>
                </p>
            </div>
        </div>
        ...
        <div class="container pt-5">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-5 col-sm-5 border shadow-sm me-2 p-4 detail-sewa">
                    <div class="ps-3">
                        <h3>Rp<span class="me-2"></span>{{number_format($detail->harga_bulan)}}</h3>
                        <form action="/penyewa/sewa-kontrakan/{{$detail->id_akomodasi}}" id="sewa" autocomplete="off" method="POST">
                          @csrf
                            <div class="form-group mt-4">
                                <input type="date" class="form-control" name="date" placeholder="Enter email">
                              </div>
                              <div class="form-group mt-4">
                                <input type="number" class="form-control" name="durasi" placeholder="Durasi (bulan)">
                                <p class="text-muted ms-2 pt-2" style="font-size: 12px">*Isi dalam satuan bulan</p>
                                {{-- <select name="durasi" id="" class="form-select">
                ...
                <div class="card deskripsi">
                  <div class="card-header d-flex p-0">
                    ...
                    <ul class="nav nav-pills ml-auto p-2">
                      ...
                      <li class="nav-item ms-3"><a class="nav-link" href="#tab_3" data-toggle="tab">Fasiltias</a></li>
