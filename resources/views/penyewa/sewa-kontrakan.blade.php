        ...
        <div class="row mt-4">
            <div class="col-lg-7 ">
                <div class="col-lg-6 ms-5">
                    <a href="/kontrakan/detail/{{$akomodasi->id_akomodasi}}" class="text-dark">
                    ...
                    <div class="col ms-5">
                        <h4>Kontrakan tersedia : {{$akomodasi->stok}}</h4>
                        ...
                        <div class="mt-4 form-group">
                            ...
                            <p class="text-muted mt-2" style="font-size: 12px">* KTP / KK dibutuhkan untuk memastikan keamanan transaksi</p>
                        </div>
                    </div>
