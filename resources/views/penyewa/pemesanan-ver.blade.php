        ...
        <div class="col-lg-6">
          <div class="card">
            ...
            <div class="card-footer">
              <form action="/penyewa/pesan-pembayaran" method="POST">
                @csrf
                <input type="hidden" value="{{$sewa->id_sewa}}" name="id_sewa">
                <button class="btn btn-primary" type="submit"><span class="fa fa-credit-card"></span> lanjut ke pembayaran</button>
              </form>
            </div>
            <!-- /.card-footer-->
          </div>
