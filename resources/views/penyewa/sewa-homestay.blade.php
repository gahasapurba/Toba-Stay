                ...
                <div class="col-lg-6 ms-5">
                    ...
                    <div class="col ms-5">
                        ...
                        <div class="mt-4 form-group">
                            ...
                            <p class="text-muted mt-2" style="font-size: 12px">* KTP dibutuhkan untuk memastikan keamanan transaksi</p>
                        </div>
                    </div>
                ...
                <div class="col shadow-sm border mt-5 sewa-detail p-5">
                    ...
                    <div class="col border-bottom m-3 pb-3">
                        <div class="row">
                            ...
                            <div class="col">
                                <p>: Rp {{number_format($akomodasi->harga_hari)}}</p>
                                <p>: Rp {{number_format($akomodasi->harga_hari*$durasi)}}</p>
                            </div>
                        </div>
                    </div>
