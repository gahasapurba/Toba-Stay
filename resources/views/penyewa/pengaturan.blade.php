                  ...
                  <div class="card-body box-profile">
                    ...
                    <div class="col-lg-9 mx-auto">
                      ...
                      <ul class="list-group list-group-unbordered mb-3">
                        ...
                        <a href="/penyewa/pengaturan/edit-profile/{{auth()->user()->id}}" class="btn btn-primary mt-4">edit</a>
                      </ul>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-lg-4">
              <div class="col">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="/penyewa/pengaturan/edit-password/{{auth()->user()->id}}" id="form-password" method="POST">
                      @csrf
                      @method('PATCH')
