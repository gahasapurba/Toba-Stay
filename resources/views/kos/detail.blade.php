        ...
        <div class="container  shadow jejak">
            <div class="p-jejak ps-2">
                <p>
                    ...
                    <a href="/kos/detail/{{ $detail->id_akomodasi }}">{{ $detail->nama_akomodasi }}</a>
                </p>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-5 col-sm-5 border shadow-sm me-2 p-4 detail-sewa">
                    <div class="ps-3">
                        ...
                        <form action="/penyewa/sewa/{{$detail->id_akomodasi}}" id="sewa" autocomplete="off" method="POST">
                          @csrf
                        ...
                        <div class="col-lg-4">
                          <table class="table table-borderless">
                            <tbody>
                              ...
                              <tr>
                                <td>No telepon</td>
                                <td>+62 8{{$detail_penyedia->no_hp}}</td>
                              </tr>
                            </tbody>
                          </table>
                        </div>
