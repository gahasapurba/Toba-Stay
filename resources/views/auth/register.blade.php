    ...
    <div class="sl-container">
        <div class="forms-container">
            <div class="signin-signup">
                <form action="{{ route('register') }}" method="POST" class="sign-in-form" autocomplete="off" enctype="multipart/form-data" >
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="img_ktp" id="file" required hidden accept="image/png, image/jpg, image/jpeg"/>
